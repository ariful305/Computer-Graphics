...
void drawSector(float startDeg, float endDeg)
{
    ...
    int ex0 = RADIUS * cos(a0);
    int ey0 = RADIUS * sin(a0);
    int ex1 = RADIUS * cos(a1);
    int ey1 = RADIUS * sin(a1);
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Easy Bresenham");
    ...
    glOrtho(-10, 10, -10, 10, -1, 1);   // zoom view

    glPointSize(5); // optional (bigger pixels)
